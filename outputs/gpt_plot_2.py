...
def plot_csv_files(file_paths):
    ...
    for file_path in file_paths:
        ...
        # 가장 적은 CO2 배출량과 에피소드 추적
        if total_co2 < min_co2:
            min_co2 = total_co2
            min_co2_episode = file_name

    # 터미널에 CO2 배출량이 가장 적은 에피소드 정보 출력
    print(f"CO2 배출량이 가장 적은 에피소드: {min_co2_episode}")
    print(f"해당 에피소드의 총 CO2 배출량: {min_co2:.2f}")
